...
<title>Generando tu orden...</title>
...
<p>Solicitando la orden.. espere un segundo.</p>
<div id="proceed"></div>
</div>
</div>
<div class="ui attached bottom message">
<div class="ui horizontal divider">Perdiste el Boleto?</div>
<form onsubmit="return ordval(this)">
<div id="refbox" class="ui icon input small">
<input placeholder="Ingrese #orden de referencia" id="refinput" required>
 <i class="search icon"></i>
</div>
<button id="printbtn" class="ui button small blue">Re-Imprimiendo</button>
</form>
