      ...
      <div class="row">
        <div class="column" id="sidebar">
          <div class="ui secondary vertical fluid menu">
            <a class="item" href="bookings.php">Reservas</a><a class="item " href="transactions.php">Actas</a><a class="active item" href="travelclass.php">Clases de Viaje</a><a class="item">Exportar</a>
