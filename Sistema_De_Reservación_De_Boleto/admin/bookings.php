      ...
      <div class="row">
        <div class="column" id="sidebar">
          <div class="ui secondary vertical fluid menu">
            <a class="active item" href="bookings.php">Reservaciones</a><a class="item" href="transactions.php">Actas</a><a class="item" href="travelclass.php">Clases Itinerantes</a><a class="item">Exportar</a>
