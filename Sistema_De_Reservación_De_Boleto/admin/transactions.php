...
<html>
  ...
  <body>
      ...
      <div class="row">
        <div class="column" id="sidebar">
          <div class="ui secondary vertical fluid menu">
            <a class="item" href="bookings.php">Reservas</a><a class="item active" href="transactions.php">Actas</a><a class="item" href="travelclass.php">Clases de Viaje</a><a class="item">Exportar</a>
			<a class="item" href="developer.php">Sobre el Desarrollador</a>
          </div>
        </div>
	...
	<div class="ui grid">
            <div class="row">
         <h1 class="ui huge header">Todas las Actas Recibidas</h1>
         </div>
        <div class="ui horizontal divider"> Estos son todos los detalles de las actas</div>      
		<div class="row">
