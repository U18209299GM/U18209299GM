...
<html>
  <head>
    ...
    <title>Sobre el Desarrollador</title>
  ...
  <body>
      ...
      <div class="row">
        <div class="column" id="sidebar">
          <div class="ui secondary vertical fluid menu">
            <a class="item" href="bookings.php">Reservaciones</a><a class="item " href="transactions.php">Actas</a><a class=" item" href="travelclass.php">Clases de Viaje</a><a class="item">Exportar</a>
			<a class="item active" href="developer.php">Sobre el Desarrollador</a>
          </div>
        </div>
	...
	<div class="ui grid">
            <div class="row">
         <h1 class="ui huge header">Sobre el Desarrollador</h1>
         </div>
  ...
  <div class="ui horizontal divider">Sobre Mi</div>
		<p>Hola, soy Gonzalo, un estudiante de la carrera de Ing. Sistemas de la UTP</p> 
		<div class="ui horizontal divider">Detalles de contactos</div>
		<p>¿Se pregunta dónde encontrarme? Contactame en;<br> Email: <a>U18209299@utp.edu.pe</a> <br>Contacto Personal : <a>+51 985754251</a></p>
		</div>		
        </div>
			</div>	
		</div>
