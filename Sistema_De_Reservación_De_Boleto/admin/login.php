...
<div class="ui attached message">
  <div class="header">!Panel de acceso de administrador!</div>
<?php
...
<form class="ui form attached fluid loading segment" method="POST">
  ...
  <div class="inline field">
    <div class="ui checkbox"><input type="checkbox" id="rememberPass"><label>Recordarlo</label></div>
  </div>
...
<i class="icon help"></i> Olvidaste tu contraseña? Simplemente use el nombre de usuario como<a href="#0"> administrador</a> y contraseña como<a href="#">contraseña</a> para acceder.
</div>
